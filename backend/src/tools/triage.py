...
class TriageTools:
    @function_tool
    async def analyze_symptoms(self, context: RunContext, symptoms: str, duration_days: int) -> str:
        ...
        critical_keywords = ["chest pain", "breathing", "breathlessness", "unconscious", "bleeding", "severe", "heart"]
